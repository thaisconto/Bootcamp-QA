...
public class Temperaturas {
    public static void main(String[] args) {
        ...
        listaTemperaturas.forEach(t -> System.out.print(t + " "));

        //calculando e exibindo a média das temperaturas:
        double media = listaTemperaturas.stream()
        ...
        listaTemperaturas.stream()
                .filter(t -> t > media)
                .forEach(t -> System.out.printf("%.1f ", t));

        //exibindo o mês das temperaturas acima da média por extenso:
        System.out.println("\n\nMeses das temperaturas acima da média: ");
        java.util.Iterator<Double> iterator = listaTemperaturas.iterator();
